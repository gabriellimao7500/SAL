...
BEGIN
    ...
    -- Segunda-feira (Laboratório 2 - Noite)
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual, 'Manhã', 5, 3, 4, 'PW3 - com professores Everson/Thayani - 3º MTEC Desenvolvimento de Sistemas');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual, 'Manhã', 6, 3, 4, 'PW3 - com professores Everson/Thayani - 3º MTEC Desenvolvimento de Sistemas');
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 1 DAY, 'Tarde', 4, 3, 1, 'DDMI2 - com professores Carlos/Danadoni - 3º MTEC Informática para internet');
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 1 DAY, 'Tarde', 2, 3, 2, 'PDTCC - com professores NATALIA C /GEOVANA - 2º MTEC INFORMATICA PARA INTERNET');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 1 DAY, 'Tarde', 3, 3, 2, 'PDTCC - com professores NATALIA C /GEOVANA - 2º MTEC INFORMATICA PARA INTERNET');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 1 DAY, 'Tarde', 4, 3, 2, 'PI - com professora LILIAN - 1º MTEC RECURSOS HUMANOS');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 1 DAY, 'Tarde', 5, 3, 2, 'PI - com professora LILIAN - 1º MTEC RECURSOS HUMANOS');
    ...
    -- Quarta-feira (Laboratório 4 - Tarde)
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 2 DAY, 'Tarde', 6, 3, 4, 'AD - com professores CARLOS - ');
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Tarde', 5, 3, 1, 'IW2 - com professor  EVERSON  - 2º MTEC Informática para internet');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Tarde', 6, 3, 1, 'IW2 - com professor  EVERSON  - 2º MTEC Informática para internet');
    ...
    -- Quinta-feira (Laboratório 3 - Manhã) *******************************************
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Manhã', 1, 3, 3, 'AI - com professor DANADONI - 1º NUTRIÇÃO E DIETÉTICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Manhã', 2, 3, 3, 'AI - com professor DANADONI - 1º NUTRIÇÃO E DIETÉTICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Manhã', 3, 3, 3, 'AI - com professor DANADONI - 1º NUTRIÇÃO E DIETÉTICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Manhã', 5, 3, 3, '? - com professores ELVIS / CARLOS - 1º QUÍMICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 3 DAY, 'Manhã', 6, 3, 3, '? - com professores ELVIS / CARLOS - 1º QUÍMICA');
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 1, 3, 1, 'UDIAD- com professor ELVIS - 3º MTEC Informática para internet');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 3, 3, 1, 'AI - com professores ELVIS / RYNALDO - 3º MTEC Informática para internet');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 4, 3, 1, 'AI - com professores ELVIS / RYNALDO - 3º MTEC Informática para internet');
    ...
    -- Sexta-feira (Laboratório 3 - Manhã)
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Manhã', 5, 3, 3, 'PDTCC - com professor PIO - 3º MTEC ADMINISTRAÇÃO');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Manhã', 6, 3, 3, 'PDTCC - com professor PIO - 3º MTEC ADMINISTRAÇÃO');

    -- Sexta-feira (Laboratório 3 - Tarde)

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 3, 3, 3, 'AD - com professor CARLOS - 3º INFORMATICA PARA INTERNET');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 4, 3, 3, 'GCW - com professor CARLOS -');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 5, 3, 3, 'FI - com professor CARLOS - 1º INFORMATICA PARA INTERNET');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 6, 3, 3, 'FI - com professor CARLOS - 1º INFORMATICA PARA INTERNET');
    ...
    -- Sexta-feira (Laboratório 4 - Manhã)
     ...
     -- Sexta-feira (Laboratório 4 - Tarde)
        ...
        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 3, 3, 4, 'AI - com professor MAURICIO - 3º NUTRIÇÃO E DIÉTICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 4, 3, 4, 'AI - com professor MAURICIO - 3º NUTRIÇÃO E DIÉTICA');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 5, 3, 4, 'CNW - com professor DONI - 3º Informática para Internet');

        INSERT INTO reserva (dataReserva, periodo, aulaReserva, idProfessor, idLaboratorio, motivo) 
        VALUES (data_atual + INTERVAL 4 DAY, 'Tarde', 6, 3, 4, 'CNW - com professor DONI - 3º Informática para Internet');
